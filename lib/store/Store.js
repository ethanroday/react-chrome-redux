...
var Store = function () {
  ...
  function Store(_ref) {
    ...
    var portName = _ref.portName,
        ...
        _ref$usePorts = _ref.usePorts,
        usePorts = _ref$usePorts === undefined ? true : _ref$usePorts;
    ...
    if (usePorts) {
      ...
      var serializedPortListener = (0, _serialization.withDeserializer)(deserializer)(function () {
        var _port$onMessage;
      ...
      var serializedMessageListener = (0, _serialization.withDeserializer)(deserializer)(function () {
      ...
      var shouldDeserialize = function shouldDeserialize(request) {
        return request.type === _constants.STATE_TYPE || request.type === _constants.PATCH_STATE_TYPE;
      };
      serializedMessageListener(handleMessage, shouldDeserialize);
      chrome.runtime.sendMessage({ type: _constants.CONNECT_TYPE }, handleMessage);
    }
